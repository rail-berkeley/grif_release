    ...
    possible_structures = {
        "gc_iql": ml_collections.ConfigDict(
            dict(
                ...
                eval_interval=5000,
                save_interval=5000,
                save_dir="gs://rail-tpus-vivek/log",
                data_path="gs://rail-tpus-vivek/data",
                resume_path="gs://rail-tpus-vivek/log/jaxrl_m_bridgedata/all_iql_20230303_064422/checkpoint_1500000",
                seed=42,
                agent_kwargs=dict(
                    network_kwargs=dict(
        ...
        "sg_sl": ml_collections.ConfigDict(
            dict(
                ...
                save_interval=5000,
                save_dir="gs://rail-tpus-vivek/log",
                data_path="gs://rail-tpus-vivek/language_all_codes",
                resume_path=None,
                seed=42,
                agent_kwargs=dict(
                    network_kwargs=dict(
        ...
        "lc_bc": ml_collections.ConfigDict(
            dict(
                ...
                save_interval=5000,
                save_dir="gs://rail-tpus-vivek/log",
                data_path="gs://rail-tpus-vivek/language_data",
                resume_path=None,
                seed=42,
                agent_kwargs=dict(
                    network_kwargs=dict(
        ...
        "sim_gc_bc": ml_collections.ConfigDict(
            dict(
                ...
                save_dir="gs://rail-tpus-vivek/log",
                data_path="gs://rail-tpus-vivek/datasets/PickPlacePosition_5K_noise_0.1_20230305-233649",
                resume_path=None,
                seed=42,
