...
[[ $# -ne 2 ]] && 
echo "Usage: bash experiments/vivek/scripts/launch_bridge.sh [config] TPU[0123]+" &&
exit 1
...
CMD="python experiments/vivek/bridgedata_offline_gc.py \
    --config experiments/vivek/configs/offline_multimodal_config.py:$CONFIG \
    --bridgedata_config experiments/vivek/configs/bridgedata_config.py:all \
    --name $NAME \
    $LAUNCH_FLAGS"
